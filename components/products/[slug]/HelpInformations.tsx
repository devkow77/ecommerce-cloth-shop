	...
	return (
		<section className="text-sm space-y-2 py-4 border-t-2 border-neutral-700 lg:text-base lg:py-8">
			<p className="text-neutral-300 leading-6 lg:leading-8">
				...
				<Link href="/contact" className="font-semibold hover:text-emerald-400 duration-200">
					Contact with me
				</Link>{' '}
				or{' '}
				<Link href="/faq" className="font-semibold hover:text-emerald-400 duration-200">
					Faq
				</Link>
			</p>
		</section>
