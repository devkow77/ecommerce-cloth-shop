		...
		<section className="grid grid-cols-2 gap-4 mt-4 mb-8 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6">
			{policityCards.length &&
				policityCards.map(({ icon, text }, key) => (
					<div key={key} className="aspect-square dark:bg-emerald-400/5 bg-slate-300 rounded-full border-2 border-emerald-400 p-4 flex flex-col items-center justify-center">
						{icon}
