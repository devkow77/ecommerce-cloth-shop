				...
				<section className="grid grid-cols-1 gap-6 px-6 py-6 lg:grid-cols-3 lg:py-8">
					...
					<div className="lg:mx-auto">
						...
						<ul className="text-sm mt-2 space-y-2 xl:text-base">
							<li className="hover:text-red-400 duration-200">
					...
					<div className="lg:flex lg:flex-col lg:items-end">
						...
						<div className="flex items-center gap-4 mt-2">
							<Link href="https://www.instagram.com" target="_blank">
								<div className="p-2 dark:bg-neutral-800 bg-slate-300 rounded-2xl dark:hover:bg-red-400 hover:bg-slate-500 duration-200 xl:text-xl">
									<FaInstagram />
								</div>
							</Link>
